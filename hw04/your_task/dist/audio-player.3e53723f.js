...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/audio-player.js":[function(require,module,exports) {
var _this = this;

var AudioPlayer = function AudioPlayer(selector, audioFile) {
  var audio;
  var playButton;
  var rwdButton;
  var ffwdButton;
  ...
  var jumpToTime = function jumpToTime() {
    var progressController = containerElement.querySelector('#player-time');
    var timeElapsed = containerElement.querySelector('#time-elapsed');
    var timeTotal = containerElement.querySelector('#time-total'); //console.log(getSliderPosition(), getCurrentTime(), getDuration());
  ...
  var customTime = function customTime(ev) {
    var newTime = audio.duration * parseInt(ev.target.value) / 100;
  ...
  var formatTime = function formatTime(timeCount) {
  ...
  _this.setAudioFile = function (audio_url) {
    audio.src = audio_url;
  };

  _this.getAudioFile = function (audio_url) {
    return audio.src;
  };
  ...
  _this.initialize = function () {
    ...
    console.log(audio, playButton); // attach events to event handlers (i.e. functions)

    audio.ontimeupdate = jumpToTime;
    audio.onended = resetTime;

    audio.onloadeddata = function () {
      console.log("preview loaded"); //resetTime();
      //this.pause();
    };

    playButton.onclick = _this.togglePlay;
...
},{}]},{},["../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/audio-player.js"], null)
//# sourceMappingURL=/audio-player.3e53723f.js.map