 ...
 * 
 */
var images = ['images/field1.jpg', 'images/purple.jpg', 'images/jar.jpg', 'images/green.jpg', 'images/green1.jpg', 'images/purple1.jpg', 'images/magnolias.jpg', 'images/daisy1.jpg'];

var initScreen = function initScreen() {
  console.log('helo');
  images.forEach(function (image, idx) {
    document.querySelector('.cards').innerHTML += "\n            <li class=\"card\">\n                <div class=\"image\" \n                    style=\"background-image:url('".concat(image, "')\"\n                    data-index=\"").concat(idx, "\"></div>\n            </li>");
  });
};
